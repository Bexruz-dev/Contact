...
const Footer = () => {
    return (
        <div>
            <footer class="footer-main" style={{paddingLeft: 150, paddingRight: 150,  marginBottom: -25}}>
                <div class="container">
                    <div class="row">
                    ...
                    <div style={{color: 'white', marginTop: 30, marginLeft: -16}}><h5>Lifetrakr</h5></div>
                                ...
                                <div class="col-lg-6 text-lg-right" style={{textAlign: 'right', paddingTop: 50}}>
                                    ...
                                    <ul class="social-icons list-inline">
                                        ...
                                        <li class="list-inline-item">
                                            <a target="_blank" href="https://instagram.com/bexruzdevloper"><i class="text-primary ti-instagram"><FaInstagram style={{fontSize: 30, color: 'white'}}/></i></a>
                                        </li>
                                    </ul>
